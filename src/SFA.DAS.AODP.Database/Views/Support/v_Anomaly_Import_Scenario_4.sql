...
/*##################################################################################################
	...
	-Description:		View for Funded Quals Import Scenario #4

						User Need:		As a member of the support team, I want to be able to 
						see qualifications marked a Funded in AOdP that do not appear on the 
						OFQUAL register but are in the Funded qualifications file so that I 
						can manually investigate and ascertain the true status of that 
						qualification and validate the information held in AoDP.
						
						Acceptance Criteria:	Given that all records are selected from the view 
						then all columns of those qualifications held by AOdP with an outcome 
						status of “Approved” that are present in the latest funded qualification 
						import and are not current OFQUAL regulated qualifications are returned
