CREATE View [dbo].[v_Anomaly_Import_Scenario_3] as

/*##################################################################################################
	-Name:				Anomaly_Import_Scenario_3
	-Description:		View for Funded Quals Import Scenario #3

						User Need:		As a member of the support team, I want to be able to 
						see qualifications not marked a Funded in AOdP that do not appear on 
						the OFQUAL register but are in the Funded qualifications file so that 
						I can manually investigate and ascertain the true status of that 
