CREATE View [dbo].[v_Anomaly_Import_Scenario_1] as

/*##################################################################################################
	-Name:				Anomaly_Import_Scenario_1
	-Description:		View for Funded Quals Import Scenario #1

						User Need:		As a member of the support team, I want to be able to see 
						qualifications marked a Funded in AOdP that do not appear on the OFQUAL 
						register nor in the Funded qualifications file so that I can manually 
