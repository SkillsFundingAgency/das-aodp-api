...
namespace SFA.DAS.AODP.Data.Repositories.Application
{
    public class ApplicationRepository : IApplicationRepository
    {
        ...
        public async Task<List<Entities.Application.Application>> GetByOrganisationId(Guid organisationId)
        {
        ...
        public async Task<Entities.Application.Application> Create(Data.Entities.Application.Application application)
        {
        ...
        public async Task<Entities.Application.Application> GetByIdAsync(Guid applicationId)
        {
            ...
            .Applications
            .FirstOrDefaultAsync(v => v.Id == applicationId);
