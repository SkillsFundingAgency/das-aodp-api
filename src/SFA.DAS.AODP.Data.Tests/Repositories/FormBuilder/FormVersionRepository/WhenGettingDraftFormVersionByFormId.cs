...
public class WhenGettingDraftFormVersionByFormId
{
        ...
        public WhenGettingDraftFormVersionByFormId() => _sut = new(
            _context.Object, 
        ...
        [Fact]
        public async Task Then_Get_Draft_FormVersion_By_Form_Id()
        {
            // Arrange
