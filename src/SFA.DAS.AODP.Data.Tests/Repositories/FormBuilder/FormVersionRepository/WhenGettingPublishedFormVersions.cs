...
public class WhenGettingPublishedFormVersions
{
    ...
    public WhenGettingPublishedFormVersions() => _sut = new(
        _context.Object, 
    ...
    [Fact]
    public async Task Then_Get_Published_FormVersions()
    {
        // Arrange
        ...
        // Act
        var result = await _sut.GetPublishedFormVersions();
