...
public class WhenArchivingFormVersion
{
    ...
    public WhenArchivingFormVersion() => _sut = new(
        _context.Object, 
    ...
    [Fact]
    public async Task When_The_FormVersion_Is_Archived()
    {  
        // Arrange
        ...
        // Act
        var result = await _sut.Archive(formId);
