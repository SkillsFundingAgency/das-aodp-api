...
public class WhenFormVersionIsEditable
{
    ...
    public WhenFormVersionIsEditable() => _sut = new(
        _context.Object, 
    ...
    [Fact]
    public async Task Then_The_FormVersion_Is_Editable()
    {  
        // Arrange
        ...
        // Act
        var result = await _sut.IsFormVersionEditable(formId);
