...
public class WhenPublishingFormVersion
{
    ...
    public WhenPublishingFormVersion() => _sut = new(
        _context.Object, 
    ...
    [Fact]
    public async Task Then_Publish_Form_Version()
    {
        // Arrange
        ...
        // Act
        var result = await _sut.Publish(formId);
