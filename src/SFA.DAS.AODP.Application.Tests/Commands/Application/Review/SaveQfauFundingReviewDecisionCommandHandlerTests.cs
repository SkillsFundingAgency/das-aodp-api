...
public class SaveQfauFundingReviewDecisionCommandHandlerTests
{
    ...
    public SaveQfauFundingReviewDecisionCommandHandlerTests()
    {
        _handler = new(
            ...
            _mediator.Object,
            _qualificationDetailsRepository.Object,
            _qualificationDiscussionHistoryRepository.Object,
    ...
    public async Task Test_Funding_Details_Updated_For_Approved_Applications_With_Qan()
    {
        ...
        _qualificationsRepository.Verify(q => q.UpdateQualificationStatus(
            qan,
            It.Is<Guid>(g => g == Guid.Parse("00000000-0000-0000-0000-000000000004")),
            qualVersion.Version.Value));
