...
{
    private readonly INewQualificationsRepository _newQualificationsRepository;

    public AddQualificationDiscussionHistoryCommandHandler(INewQualificationsRepository newQualificationsRepository)
    {
        _newQualificationsRepository = newQualificationsRepository;
    }
    ...
    public async Task<BaseMediatrResponse<EmptyResponse>> Handle(AddQualificationDiscussionHistoryCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await _newQualificationsRepository.AddQualificationDiscussionHistory(qualificationDiscussionHistory, request.QualificationReference);
